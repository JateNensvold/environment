...
# #   List all files
# alias xa="eza --group-directories-first -laa --time-style=long-iso"
# #   List files grouped by directory first
# alias  xl="eza --group-directories-first -l"
# #   List Tree of files
# alias xt="eza -T"
# #   List all files in current directory and pipe to fzf
# alias xf="eza --group-directories-first -l | fzf ${FZF_DEFAULT_OPTS} -m --header='[eza:files]'"
