...
$WINDOWS_SETUP_SCRIPT_PATH = (Join-Path (Join-Path $REPOSITORY_NAME $SCRIPTS_FOLDER_NAME) (Join-Path $WINDOWS_SCRIPTS_FOLDER_NAME $WINDOWS_SETUP_SCRIPT_NAME))

& $WINDOWS_SETUP_SCRIPT_PATH